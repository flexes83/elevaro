...
<nav class="navbar recommendations-nav">
  <div class="container">
    <a class="navbar-brand fw-bold" href="/">Elevaro</a>
    <a href="onboarding.php" class="btn btn-sm btn-outline-primary">Auswahl ändern</a>
  </div>
</nav>
  ...
  <div class="container">
    ...
    <section class="recommendations-section">
      <div class="section-title-row">
        <div>
          <span id="topicKicker" class="eyebrow d-none">Ausgewähltes Thema</span>
          <h2>Empfohlene Quizze</h2>
          <p id="sectionIntro">Starte mit einem Thema, das wirklich zu deinem Lernstand passt.</p>
        </div>

        <a href="onboarding.php" class="change-link">Neu auswählen</a>
      </div>
