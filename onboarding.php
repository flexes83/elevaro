  ...
  <div class="container">
    <div class="onboarding-shell mx-auto">
      ...
      <div class="progress mb-4" style="height: 10px;">
        <div id="stepProgress" class="progress-bar" style="width: 20%"></div>
      </div>
      ...
      <div class="onboarding-card">
        <div class="row g-4 align-items-center">
          ...
          <div class="col-lg-8">
            <div id="stepBadge" class="step-badge mb-2">Schritt 1 von 5</div>
            <h1 id="stepTitle" class="fw-bold mb-2">Wo gehst du zur Schule?</h1>
            <p id="stepText" class="text-muted mb-4">
              Wähle dein Bundesland. Dadurch können wir später Themen nach dem passenden Lehrplan vorschlagen.
            </p>
            ...
            <div class="d-flex justify-content-between gap-3 mt-4">
              ...
              <button id="skipBtn" class="btn btn-outline-secondary">Später auswählen</button>
            </div>
          </div>
        </div>
      </div>
