  ...
  els.choices.innerHTML = `
    <div class="name-step-card">
      ...
      <div class="name-input-row">
        ...
        <button id="nameContinueBtn" class="btn btn-primary btn-lg">Weiter</button>
      </div>
...
async function render() {
  ...
  els.hint.textContent = personalize(step.hint);
  els.badge.textContent = `Schritt ${state.step + 1} von ${steps.length}`;
  els.title.textContent = personalize(step.title);
  els.text.textContent = personalize(step.text);
